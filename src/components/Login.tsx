    ...
    <div className="flex justify-center items-center h-screen bg-gradient-to-br from-gray-200 to-white">
      <div className="bg-white shadow-lg rounded-lg w-full max-w-4xl flex overflow-hidden">
        ...
        <div className="w-1/2 bg-gray-200">
          <img
            src="https://storage.guss.dev.br/typebot/public/workspaces/cm5l2dige0000q70dd6nue9x1/typebots/cm6jq7pg90013q70dpz8fh5gr/blocks/e3p23lli7i0tpfebvybc83bg?v=1738804312864"
            ...
            <button
              ...
              className={`w-full py-2 px-4 rounded-lg text-white ${
                loading
                  ...
                  : "bg-gradient-to-r from-blue-900 to-blue-700 hover:bg-gradient-to-r hover:from-blue-800 hover:to-blue-600"
              }`}
            >
